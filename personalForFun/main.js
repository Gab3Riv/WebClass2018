var randomOne = function(){
    ...
    document.getElementById("firstNum").value = randomNum;
}
var randomTwo = function(){
    var randomNum = Math.floor(Math.random()*10);
    document.getElementById("secondNum").value = randomNum;
}
var randomThree = function(){
    var randomNum = Math.floor(Math.random()*10);
    document.getElementById("thirdNum").value = randomNum;
}
var raffle = function(){
    var i = 0;
